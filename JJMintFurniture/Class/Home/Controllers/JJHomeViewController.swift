...
class JJHomeViewController: UIViewController ,UIScrollViewDelegate{
    ...
    func addChildVC() {
        for _ in 0..<titlesArray.count {
            let vc = JJTestTableViewController()
...
//        automaticallyAdjustsScrollViewInsets = false//自动设置相应的内边距
    ...
    private lazy var titlesView: UIView = {
        ...
        titlesView.frame = CGRect(x: 0, y: 0, width: ScreenWidth - kTitlesViewH, height: kTitlesViewH)
        return titlesView
    }()
    ...
    private lazy var arrowButton: UIButton = {
        ...
        arrowButton.frame = CGRect(x: ScreenWidth - kTitlesViewH, y: 0, width: kTitlesViewH, height: kTitlesViewH)
