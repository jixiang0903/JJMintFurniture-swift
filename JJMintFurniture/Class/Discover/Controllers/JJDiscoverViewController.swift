//
//  JJDiscoverViewController.swift
//  JJMintFurniture
//
...
class JJDiscoverViewController: UIViewController, UITableViewDelegate, UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        switch indexPath.row {
        case 0:
            let tableVC = JJDiscoverTableViewController()
            tableVC.type = tableViewType.haveHeader
            navigationController?.pushViewController(tableVC, animated: true)
        case 1:
            let tableVC = JJDiscoverTableViewController()
            tableVC.type = tableViewType.noHeader
            navigationController?.pushViewController(tableVC, animated: true)
        case 2:
            navigationController?.pushViewController(JJDiscoverScrollView(), animated: true)
        case 3:
            navigationController?.pushViewController(JJDiscoverCollectionViewController(), animated: true)
        default:
            return
        }
    }
